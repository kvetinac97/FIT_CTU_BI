 ...
 */
final class Version20211226211159 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE room (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, group_id INTEGER DEFAULT NULL, building_id INTEGER NOT NULL, name VARCHAR(128) NOT NULL COLLATE BINARY, public BOOLEAN NOT NULL, open BOOLEAN NOT NULL, CONSTRAINT FK_729F519BFE54D947 FOREIGN KEY (group_id) REFERENCES "group" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_729F519B4D2A7E12 FOREIGN KEY (building_id) REFERENCES building (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(255) NOT NULL COLLATE BINARY, name VARCHAR(128) NOT NULL COLLATE BINARY, tel VARCHAR(16) NOT NULL, image VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, name, tel, image FROM "user"');
        $this->addSql('DROP TABLE "user"');
        $this->addSql('CREATE TABLE "user" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(255) NOT NULL, name VARCHAR(128) NOT NULL, tel VARCHAR(16) DEFAULT NULL COLLATE BINARY, image VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO "user" (id, email, name, tel, image) SELECT id, email, name, tel, image FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON "user" (email)');
    }
