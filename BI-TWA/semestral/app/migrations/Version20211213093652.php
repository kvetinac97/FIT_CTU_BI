 ...
 */
final class Version20211213093652 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO room (id, group_id, building_id, name, public, open) SELECT id, group_id, building_id, name, public, 0 FROM __temp__room');
