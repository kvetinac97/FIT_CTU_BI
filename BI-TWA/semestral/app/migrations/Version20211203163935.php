 ...
 */
final class Version20211203163935 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(128) NOT NULL, tel VARCHAR(16) DEFAULT NULL, roles CLOB NOT NULL --(DC2Type:json)
        )');
