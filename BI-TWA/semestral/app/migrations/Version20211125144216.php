 ...
 */
final class Version20211125144216 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E16F61D45E237E06 ON building (name)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6DC044C561997596 ON "group" (parent_group_id)');
        ...
        $this->addSql('CREATE TABLE reservation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, room_id INTEGER NOT NULL, group_id INTEGER DEFAULT NULL, approved BOOLEAN NOT NULL, cancelled BOOLEAN NOT NULL, start DATETIME NOT NULL, until DATETIME NOT NULL, CONSTRAINT FK_42C84955F675F31B FOREIGN KEY (author_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_42C8495554177093 FOREIGN KEY (room_id) REFERENCES room (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_42C84955FE54D947 FOREIGN KEY (group_id) REFERENCES "group" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO reservation (id, author_id, room_id, group_id, approved, cancelled, start, until) SELECT id, author_id, room_id, group_id, approved, cancelled, start, until FROM __temp__reservation');
        ...
        $this->addSql('CREATE INDEX IDX_42C84955FE54D947 ON reservation (group_id)');
        $this->addSql('DROP INDEX ix_reservation_user_user_id');
        $this->addSql('DROP INDEX ix_reservation_user_reservation_id');
        ...
        $this->addSql('CREATE TABLE room (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, group_id INTEGER NOT NULL, building_id INTEGER NOT NULL, name VARCHAR(128) NOT NULL COLLATE BINARY, public BOOLEAN NOT NULL, CONSTRAINT FK_729F519BFE54D947 FOREIGN KEY (group_id) REFERENCES "group" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_729F519B4D2A7E12 FOREIGN KEY (building_id) REFERENCES building (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, password, name, tel, admin, roles FROM user');
        ...
        $this->addSql('INSERT INTO user (id, email, password, name, tel, admin, roles) SELECT id, email, password, name, tel, admin, roles FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_E16F61D45E237E06');
        $this->addSql('CREATE TEMPORARY TABLE __temp__building AS SELECT id, name FROM building');
        $this->addSql('DROP TABLE building');
        ...
        $this->addSql('DROP INDEX UNIQ_6DC044C561997596');
        $this->addSql('CREATE TEMPORARY TABLE __temp__group AS SELECT id, parent_group_id, name FROM "group"');
        $this->addSql('DROP TABLE "group"');
        ...
        $this->addSql('DROP INDEX IDX_42C84955FE54D947');
        $this->addSql('CREATE TEMPORARY TABLE __temp__reservation AS SELECT id, author_id, room_id, group_id, approved, cancelled, start, until FROM reservation');
        $this->addSql('DROP TABLE reservation');
        $this->addSql('CREATE TABLE reservation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, room_id INTEGER NOT NULL, group_id INTEGER DEFAULT NULL, approved BOOLEAN NOT NULL, cancelled BOOLEAN NOT NULL, start DATETIME NOT NULL, until DATETIME NOT NULL)');
        $this->addSql('INSERT INTO reservation (id, author_id, room_id, group_id, approved, cancelled, start, until) SELECT id, author_id, room_id, group_id, approved, cancelled, start, until FROM __temp__reservation');
        $this->addSql('DROP TABLE __temp__reservation');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, password, name, tel, admin, roles FROM "user"');
        $this->addSql('DROP TABLE "user"');
        $this->addSql('CREATE TABLE "user" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(128) NOT NULL, tel VARCHAR(16) DEFAULT NULL, admin BOOLEAN NOT NULL, roles CLOB NOT NULL COLLATE BINARY --(DC2Type:json)
        )');
        $this->addSql('INSERT INTO "user" (id, email, password, name, tel, admin, roles) SELECT id, email, password, name, tel, admin, roles FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
