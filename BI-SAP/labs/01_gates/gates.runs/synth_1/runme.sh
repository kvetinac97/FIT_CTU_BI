...
HD_PWD='C:/Users/wrzecond/Documents/zatimsap/gates/gates.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gates_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gates_wrapper.tcl
