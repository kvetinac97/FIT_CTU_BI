...
HD_PWD='C:/Users/wrzecond/Documents/zatimsap/gates/gates.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gates_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gates_wrapper.tcl -notrace
