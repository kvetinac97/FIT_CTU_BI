...
HD_PWD='C:/Users/wrzecond/Documents/zatimsap/gates/gates.runs/gates_xor_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gates_xor_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gates_xor_0_0.tcl
