...
HD_PWD='C:/testsap/pravdivostni/pravdivostni.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log algebra_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source algebra_4.tcl -notrace
