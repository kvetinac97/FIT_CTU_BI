...
HD_PWD='C:/testsap/pravdivostni/pravdivostni.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log algebra_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source algebra_4.tcl
