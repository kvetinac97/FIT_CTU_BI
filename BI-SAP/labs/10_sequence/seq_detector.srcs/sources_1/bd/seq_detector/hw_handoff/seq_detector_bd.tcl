...
################################################################
# This is a generated script based on design: seq_detector
#
...
# source seq_detector_script.tcl
...
proc create_root_design { parentCell } {
  ...
  set detect [ create_bd_port -dir O detect ]
  set reset [ create_bd_port -dir I reset ]
  set s0 [ create_bd_port -dir O -type data s0 ]
  set s1 [ create_bd_port -dir O -type data s1 ]
  set s2 [ create_bd_port -dir O -type data s2 ]
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk] [get_bd_pins debounce_0/clk]
  connect_bd_net -net debounce_0_tl_out [get_bd_pins debounce_0/tl_out] [get_bd_pins dff_0/clk] [get_bd_pins dff_1/clk] [get_bd_pins dff_2/clk]
  connect_bd_net -net dff_0_q [get_bd_ports s0] [get_bd_pins dff_0/q] [get_bd_pins next_state_logic_0/q0] [get_bd_pins output_logic_0/q0]
  connect_bd_net -net dff_1_q [get_bd_ports s1] [get_bd_pins dff_1/q] [get_bd_pins next_state_logic_0/q1] [get_bd_pins output_logic_0/q1]
  connect_bd_net -net dff_2_q [get_bd_ports s2] [get_bd_pins dff_2/q] [get_bd_pins next_state_logic_0/q2] [get_bd_pins output_logic_0/q2]
  ...
  connect_bd_net -net output_logic_0_y [get_bd_ports detect] [get_bd_pins output_logic_0/y]
  connect_bd_net -net reset_0_1 [get_bd_ports reset] [get_bd_pins dff_0/reset] [get_bd_pins dff_1/reset] [get_bd_pins dff_2/reset]
  connect_bd_net -net sw_1_1 [get_bd_ports switch] [get_bd_pins next_state_logic_0/sw] [get_bd_pins output_logic_0/sw]
  connect_bd_net -net tl_in_0_1 [get_bd_ports btn] [get_bd_pins debounce_0/tl_in]
  connect_bd_net -net vcc_0_O [get_bd_pins dff_0/ce] [get_bd_pins dff_1/ce] [get_bd_pins dff_2/ce] [get_bd_pins vcc_0/O]
