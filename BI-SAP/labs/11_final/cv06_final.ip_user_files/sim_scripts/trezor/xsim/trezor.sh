...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot trezor xil_defaultlib.trezor -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim trezor -key {Behavioral:sim_1:Functional:trezor} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb trezor.wdb xsim.dir)
