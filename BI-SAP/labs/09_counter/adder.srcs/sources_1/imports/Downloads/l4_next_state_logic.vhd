...
begin
  ...
  d0 <= ( ( DIR and (not q2) ) xor ( (not q2) and q1 ) ); -- Keep connected to '0' if you do not use it // pokud tento vystup nevyuzijete, nechte jej pripojeny k log. 0 (kvuli simulaci)
  d1 <= ( ( (not DIR) and q2 ) or ( DIR and q0 ) or ( (not q2) and q1 and (not q0) ) ); -- Keep connected to '0' if you do not use it // pokud tento vystup nevyuzijete, nechte jej pripojeny k log. 0 (kvuli simulaci)
  d2 <= ( ( (not DIR) and (not q1) and (not q0) ) or ( DIR and q1 and (not q0) ) ); -- Keep connected to '0' if you do not use it // pokud tento vystup nevyuzijete, nechte jej pripojeny k log. 0 (kvuli simulaci)
