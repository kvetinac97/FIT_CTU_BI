...
#
# Generated by Vivado on Thu Mar 26 17:08:38 +0100 2020
...
# Script info
echo -e "adder.sh - Script generated by export_simulation (Vivado v2018.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot adder xil_defaultlib.adder -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim adder -key {Behavioral:sim_1:Functional:adder} -tclbatch cmd.tcl -log simulate.log
}
