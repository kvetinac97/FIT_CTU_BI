...
HD_PWD='C:/testsap/scitacka/scitacka.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_vhdl.tcl
