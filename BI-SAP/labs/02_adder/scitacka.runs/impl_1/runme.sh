...
HD_PWD='C:/testsap/scitacka/scitacka.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_vhdl.tcl -notrace
