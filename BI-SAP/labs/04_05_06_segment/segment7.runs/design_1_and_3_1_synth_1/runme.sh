...
HD_PWD='C:/testsap/segment7/segment7.runs/design_1_and_3_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_and_3_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_and_3_1.tcl
