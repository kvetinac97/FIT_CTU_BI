...
--            ---     ---     ---     ---
   ...
   f_a <= (a and not b) xor (not b and c and not d) xor (a and not c and d);  -- <- DOPLÒTE VÝRAZ
   f_b <= ((c and d) xor (a and not b and c)) or (a and b and d) or (not a and b and c);  -- <- DOPLÒTE VÝRAZ
   f_c <= (not a and b and not c and not d) or (b and c and d) or (not a and c and d);  -- <- DOPLÒTE VÝRAZ
